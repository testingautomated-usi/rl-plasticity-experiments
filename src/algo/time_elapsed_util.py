...
def save_time_elapsed(save_dir: str, current_iteration: int, execution_times: List[float], regression: bool = False) -> None:
    filename = (
        save_dir + "/time_elapsed_" + str(current_iteration) + ".txt"
        if not regression
