...
class PendulumEnvVariables(EnvVariables):
    ...
    def __init__(self, algo_name, dt=None, mass=None, length=None,
                 discrete_action_space: bool = False, param_names: List[str] = None, model_suffix: str = None):
        ...
        params_length = load_env_params(algo_name=algo_name, env_name='pendulum', param_name='length', model_suffix=model_suffix)
