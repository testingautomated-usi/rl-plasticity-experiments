...
class AcrobotEnvVariables(EnvVariables):
    def __init__(
        ...
        params_link_length_1 = load_env_params(
            algo_name=algo_name, env_name="acrobot", param_name="link_length_1", model_suffix=model_suffix
        )
        params_link_mass_1 = load_env_params(
            algo_name=algo_name, env_name="acrobot", param_name="link_mass_1", model_suffix=model_suffix
        )
        params_link_mass_2 = load_env_params(
            algo_name=algo_name, env_name="acrobot", param_name="link_mass_2", model_suffix=model_suffix
        )
        params_link_com_pos_1 = load_env_params(
            algo_name=algo_name, env_name="acrobot", param_name="link_com_pos_1", model_suffix=model_suffix
        )
        params_link_com_pos_2 = load_env_params(
            algo_name=algo_name, env_name="acrobot", param_name="link_com_pos_2", model_suffix=model_suffix
        )
        params_link_moi = load_env_params(
            algo_name=algo_name, env_name="acrobot", param_name="link_moi", model_suffix=model_suffix
        )
