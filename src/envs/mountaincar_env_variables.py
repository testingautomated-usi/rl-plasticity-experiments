...
class MountainCarEnvVariables(EnvVariables):
    ...
    def __init__(self, algo_name,
        ...
        param_goal_velocity = load_env_params(algo_name=algo_name, env_name='mountaincar', param_name='goal_velocity', model_suffix=model_suffix)
        params_force = load_env_params(algo_name=algo_name, env_name='mountaincar', param_name='force', model_suffix=model_suffix)
        params_gravity = load_env_params(algo_name=algo_name, env_name='mountaincar', param_name='gravity', model_suffix=model_suffix)
